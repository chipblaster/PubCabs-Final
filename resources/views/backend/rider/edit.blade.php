                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-title-box">
                            <h4 class="page-title float-left">Rider Edit</h4>
	                            ...
	                            <div class="form-group row">
	                                ...
	                                <div class="col-sm-7">
	                                    <input type="email" placeholder="Description" name="description" required parsley-type="text" class="form-control"
	                                           id="inputEmail3" value="{{$rider->description}}">
	                                </div>
	                            </div>
	                            <div class="form-group row">
	                                <label for="hori-pass1" class="col-sm-4 form-control-label">Photo</label>
	                                <div class="col-sm-7">
	                                	 <input type="file" class="dropify" name="banner_img" data-default-file="{{asset('assets/upload/'.$rider->banner_img)}}" value="{{$rider->banner_img}}" />
	                                </div>
	                            </div>
	                            <div class="form-group row">
	                                <label for="hori-pass2" class="col-sm-4 form-control-label">Content Image</label>
	                                <div class="col-sm-7">
	                                    <input type="file" class="dropify" name="content_img" data-default-file="{{asset('assets/upload/'.$rider->content_img)}}" value="{{$rider->content_img}}" />
