                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-title-box">
                            <h4 class="page-title float-left">Social Edit</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <form role="form" data-parsley-validate novalidate action="{{route('social.update',['id' => $social->id])}}" method="post">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="email" placeholder="Name" name="name" required parsley-type="text" class="form-control"
                                               id="inputEmail3" value="{{$social->name}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="email" placeholder="Icon Name" name="icon" required parsley-type="text" class="form-control"
                                               id="inputEmail3" value="{{$social->icon}}">
                                    </div>
                                </div>
                                <div class="form-group row">
